package cn.wuxi.js.lib4.common.web;
...
public class ActivitiController extends BaseController {
    ...
    @RequestMapping(value = "toProcessTracking")
    public String toProcessTracking(String processDefId, String executionId, String procInsId, Model model) throws Exception { 
    	
    	model.addAttribute("procDefId", processDefId);
    	
    	model.addAttribute("procInsId", procInsId);
    	if(StringUtils.isEmpty(executionId)){
    		executionId = procInsId;
    	}
