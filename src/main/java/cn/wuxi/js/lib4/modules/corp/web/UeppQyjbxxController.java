 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/corp/ueppQyjbxx")
public class UeppQyjbxxController extends BaseController {
	...
	@RequiresPermissions("corp:ueppQyjbxx:view")
	@RequestMapping(value = {"list", ""})
	public String list(UeppQyjbxx ueppQyjbxx, HttpServletRequest request, HttpServletResponse response, Model model) {
		Page<UeppQyjbxx> page = ueppQyjbxxService.findPage(new Page<UeppQyjbxx>(request, response), ueppQyjbxx); 
		model.addAttribute("page", page);
		return "modules/corp/ueppQyjbxxList";
	}

	@RequiresPermissions("corp:ueppQyjbxx:view")
	@RequestMapping(value = "form")
	public String form(UeppQyjbxx ueppQyjbxx, Model model) {
		model.addAttribute("ueppQyjbxx", ueppQyjbxx);
		return "modules/corp/ueppQyjbxxForm";
	}
	...
	public String save(UeppQyjbxx ueppQyjbxx, Model model, RedirectAttributes redirectAttributes) {
		...
		ueppQyjbxxService.save(ueppQyjbxx);
