			...
			<c:forEach items="${list}" var="act">
				...
				<tr>
					...
					<td>
						...
						<a href="${ctx}/common/activiti/toProcessTracking?processDefId=${task.processDefinitionId}&executionId=${task.processInstanceId}&procInsId=${task.processInstanceId}" target="_blank">流程追踪</a><%-- 
