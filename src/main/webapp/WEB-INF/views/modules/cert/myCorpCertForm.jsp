...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/mycorp/cert/form?id=${corpCert.id}">企业资质<shiro:hasPermission name="cert:corpCert:edit">${not empty corpCert.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cert:corpCert:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="corpCert" action="${ctx}/mycorp/cert/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
